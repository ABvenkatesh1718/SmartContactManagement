...
public class SecurityConfig {
	...
	public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, UserDetailsServiceImp userDetailsServiceImp, CustomAccessDeniedHandler accessDeniedHandler) {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http
				...
				.authorizeHttpRequests(req -> req
						...
						.requestMatchers ("/home","/index.html","/icon.jpg").permitAll()
